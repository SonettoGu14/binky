...
- **Top-level window tabs** (`TabView` with tab items): Reserve for **major areas** of the settings window (General, Destinations, Automations, Shortcuts, Appearance)—not for small sub-panes inside a tab.
