...
- **Top-level window tabs** (`TabView` with tab items): Reserve for **major areas** of the settings window (General, Destinations, Watch, Presets)—not for small sub-panes inside a tab.
