...
private let urlDownloadLogger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Binky", category: "URLDownloader")
...
enum URLDownloader {
    ...
    private static let session: URLSession = {
        ...
        cfg.httpAdditionalHeaders = [
            "User-Agent": "Binky/\(ver) (+https://binkyfiles.com)",
    ...
    /// Final path under `FileManager.default.temporaryDirectory/Binky-Downloads/`.
    ...
    static func downloadsScratchDirectory() -> URL {
        FileManager.default.temporaryDirectory.appendingPathComponent("Binky-Downloads", isDirectory: true)
    }
...
enum URLDownloaderError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .unsupportedType:
            return "That file type isn’t supported by Binky."
        case .tooLarge:
