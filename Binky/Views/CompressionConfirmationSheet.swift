            ...
            Group {
                ...
                if showSmartQualityToggle {
                    Toggle(String(localized: "Smart quality (all types)", comment: "Sidebar: global smart quality for images, PDF, and video."), isOn: clearingSmartQualityBinding)
                        .font(.callout)
                    Text(String(localized: "When on, Binky picks encoder strength per file (images, PDF flatten, video). Turn off for manual choices in each section below.", comment: "Compression confirm: smart quality footnote."))
                        .font(.caption2)
                        .foregroundStyle(.tertiary)
                        .fixedSize(horizontal: false, vertical: true)
                }
                ...
                Picker(String(localized: "Filename", comment: "Settings UI."), selection: clearingFilenameHandlingBinding) {
                    Text(String(localized: "Append \"-binky\" suffix", comment: "Settings UI.")).tag(FilenameHandling.appendSuffix)
                ...
                if prefs.filenameHandling == .customSuffix {
                    HStack {
                        Text(String(localized: "Suffix", comment: "Settings UI."))
                            .font(.caption)
                            .foregroundStyle(.secondary)
                        TextField(String(localized: "-binky", comment: "Settings UI."), text: clearingCustomSuffixBinding)
