...
/// Shared brand tint pulled from the app icon's magenta family.
let binkyTintColor = Color(red: 0.89, green: 0.21, blue: 0.43)

let binkyGradient = LinearGradient(
    colors: [Color(red: 0.93, green: 0.24, blue: 0.48), Color(red: 0.79, green: 0.18, blue: 0.56)],
    startPoint: .leading,
    endPoint: .trailing
)
